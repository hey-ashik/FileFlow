    ...
    <div class="container">
                    ...
                    <?php else: ?>
                        ...
                        <div class="filetype-stat-row">
                            ...
                            <div class="filetype-stat-bar-wrap">
                                <div class="filetype-stat-bar" style="width:<?php echo $pct; ?>%;background:<?php echo $color; ?>"></div>
                            </div>
        ...
        <div class="dash-folders-section" style="margin-bottom: 28px;" id="create-section">
            ...
            <div style="padding: 24px;">
                <div class="create-card" id="create-card" style="box-shadow: none; border: none; padding: 0; margin: 0; max-width: 100%;">
                    <div class="create-card-inner">
                        <form id="create-folder-form" class="create-form" autocomplete="off" style="margin-top: 0;">
                            <div class="input-group">
                                <div class="input-prefix">
                                    <span class="prefix-url"><?php echo str_replace(['https://', 'http://'], '', APP_URL); ?>/</span>
                                </div>
                                <input type="text" id="folder-name-input" name="folder_name" class="input-field" placeholder="my-awesome-folder" maxlength="<?php echo FOLDER_NAME_MAX_LENGTH; ?>" pattern="[a-zA-Z0-9][a-zA-Z0-9_-]*" required autocomplete="off">
                            ...
                            <div class="input-hint" id="folder-hint" style="text-align: left; justify-content: flex-start; margin-top: 8px;">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                                Use letters, numbers, hyphens, or underscores. Min <?php echo FOLDER_NAME_MIN_LENGTH; ?> characters.
                            </div>
                        </form>
                        
                        <!-- Success State -->
                        <div class="create-success" id="create-success" style="display:none; text-align: left; padding: 16px; background: var(--green-50); border: 1px solid var(--green-200); border-radius: var(--radius); margin-top: 16px;">
                            <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
                                <div style="flex: 1; min-width: 250px;">
                                    <h4 style="color: var(--green-700); margin-bottom: 8px; font-size: 1rem; display: flex; align-items: center; gap: 8px;">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>
                                        Folder Created Successfully!
                                    </h4>
                                    <div class="success-url-box" style="margin-bottom: 0;">
                                        <input type="text" id="success-url" class="success-url-input" style="background: var(--white);" readonly>
                                        <button class="btn btn-sm btn-copy" onclick="copyFolderUrl()" id="btn-copy-url">Copy</button>
                                    </div>
                                </div>
                                <div style="display: flex; flex-direction: column; gap: 8px; min-width: 140px;">
                                    <a href="#" class="btn btn-primary btn-sm" style="justify-content: center;" id="btn-goto-folder">Open Folder</a>
                                    <button class="btn btn-ghost btn-sm" style="justify-content: center;" onclick="resetCreateForm()" id="btn-create-another">Create Another</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="dash-folders-section">
            <div class="dash-card-header">
                <h3>Your Folders</h3>
                <button onclick="document.getElementById('folder-name-input').focus()" class="btn btn-sm btn-primary">+ New Folder</button>
            </div>
            <div class="dash-folders-grid" id="dash-folders">
                <?php if (empty($folders)): ?>
                    <div class="dash-empty">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="opacity:.3"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
                        <h4>No folders yet</h4>
                        <p>Create your first folder to get started</p>
                        <button onclick="document.getElementById('folder-name-input').focus()" class="btn btn-primary btn-sm">Create Folder</button>
                    </div>
                <?php else: ?>
                    <?php foreach ($folders as $f): ?>
                    <a href="/<?php echo htmlspecialchars($f['slug']); ?>/" class="dash-folder-card" id="dash-folder-<?php echo $f['id']; ?>">
