...
function renderThoughtCard($thought, $currentUserId = null, $isSinglePage = false) {
    ...
    echo '<div>';
    echo '<a href="/u/' . htmlspecialchars($thought['profile_slug']) . '" data-no-spa="true" style="text-decoration: none; color: var(--gray-900); font-weight: 700; font-size: 1.05rem;">' . htmlspecialchars($thought['full_name']) . getVerifiedBadgeHtml($thought['is_verified'] ?? 0) . '</a>';
