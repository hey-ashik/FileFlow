    ...
    <div class="auth-card">
        <div class="auth-header">
            <div class="auth-icon auth-icon-register">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>
            </div>
        ...
        <form id="register-form" class="auth-form" autocomplete="on">
            <div class="form-group">
                ...
                <div class="form-input-wrap">
                    ...
                    <input type="text" id="reg-name" name="full_name" placeholder="John Doe" required minlength="2" maxlength="100" autocomplete="name">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-input-wrap">
                    ...
                    <input type="password" id="reg-password" name="password" placeholder="Min 6 characters" required minlength="6" autocomplete="new-password">
            ...
            <div class="form-group">
                ...
                <div class="form-input-wrap">
                    ...
                    <input type="password" id="reg-confirm" name="confirm_password" placeholder="Confirm password" required minlength="6" autocomplete="new-password">
                </div>
            </div>
