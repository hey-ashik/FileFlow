...
<head>
    ...
    <!-- Main Stylesheet -->
    <?php $ver = '3.0.2'; // Using static version for better performance via browser caching ?>
            ...
            <div class="navbar-links" id="nav-links">
                <div class="navbar-center-pill">
                    ...
                    <?php else: ?>
                        ...
                        <a href="/register" class="nav-link <?php echo $currentPage === 'register' ? 'active' : ''; ?>" id="nav-register">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="navbar-right-actions">
                    <?php if (isLoggedIn()): ?>
                        ...
                        <div class="nav-dropdown" id="nav-dropdown">
                            ...
                            <a href="/logout" class="nav-dropdown-item nav-dropdown-logout" onclick="window.location.href='/logout'; return false;">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
